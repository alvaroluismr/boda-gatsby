            ...
            <div className={indicacionesStyle.row}>
                <div className={indicacionesStyle.colum}>
                    <div className={indicacionesStyle.texto} >
                        ...
                        <ul>
                            <li><spam className={indicacionesStyle.tipoinfo}>Lugar:</spam> Iglesia de San Francisco</li>
                            <li><spam className={indicacionesStyle.tipoinfo}>Hora:</spam> 18:00</li>
                            <li><spam className={indicacionesStyle.tipoinfo}>Direción:</spam> Plaza San Francisco, s/n (Cádiz)</li>
                ...
                <div className={indicacionesStyle.colum}>
                    <div className={indicacionesStyle.texto} >
                        ...
                        <ul>
                            <li><spam className={indicacionesStyle.tipoinfo}>Lugar:</spam> Finca Alboreá</li>
                            <li><spam className={indicacionesStyle.tipoinfo}>Hora:</spam> 20:00</li>
